...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@shawnma/pi-coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@shawnma/pi-tui";
