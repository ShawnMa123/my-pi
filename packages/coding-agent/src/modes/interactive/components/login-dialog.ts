import type { AuthInfoLink, OAuthDeviceCodeInfo } from "@shawnma/pi-ai";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@shawnma/pi-tui";
