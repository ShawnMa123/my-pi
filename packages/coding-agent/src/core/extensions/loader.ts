...
import * as _bundledPiAgentCore from "@shawnma/pi-agent-core";
import type { Provider } from "@shawnma/pi-ai";
import * as _bundledPiAiCompat from "@shawnma/pi-ai/compat";
import * as _bundledPiAiOauth from "@shawnma/pi-ai/oauth";
import * as _bundledPiAiProviders from "@shawnma/pi-ai/providers/all";
import type { KeyId } from "@shawnma/pi-tui";
import * as _bundledPiTui from "@shawnma/pi-tui";
...
// avoiding a circular dependency. Extensions can import from @shawnma/pi-coding-agent.
...
const VIRTUAL_MODULES: Record<string, unknown> = {
	...
	"@shawnma/pi-agent-core": _bundledPiAgentCore,
	"@shawnma/pi-tui": _bundledPiTui,
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	"@shawnma/pi-ai": _bundledPiAiCompat,
	"@shawnma/pi-ai/compat": _bundledPiAiCompat,
	"@shawnma/pi-ai/oauth": _bundledPiAiOauth,
	"@shawnma/pi-ai/providers/all": _bundledPiAiProviders,
	"@shawnma/pi-coding-agent": _bundledPiCodingAgent,
...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@shawnma/pi-agent-core");
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@shawnma/pi-tui");
	// Extensions resolve the pi-ai root to the compat entrypoint (a strict
	// superset of the core entrypoint): existing extensions using the old
	// global API keep working at runtime until compat is removed.
	const piAiCompatEntry = resolveWorkspaceOrImport("ai/dist/compat.js", "@shawnma/pi-ai/compat");
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@shawnma/pi-ai/oauth");
	const piAiProvidersEntry = resolveWorkspaceOrImport("ai/dist/providers/all.js", "@shawnma/pi-ai/providers/all");

	_aliases = {
		"@shawnma/pi-coding-agent": piCodingAgentEntry,
		"@shawnma/pi-agent-core": piAgentCoreEntry,
		"@shawnma/pi-tui": piTuiEntry,
		"@shawnma/pi-ai/providers/all": piAiProvidersEntry,
		"@shawnma/pi-ai/compat": piAiCompatEntry,
		"@shawnma/pi-ai/oauth": piAiOauthEntry,
		"@shawnma/pi-ai": piAiCompatEntry,
