...
import { Agent, type AgentMessage, setDefaultStreamFn, type ThinkingLevel } from "@shawnma/pi-agent-core";
import { clampThinkingLevel, type Message, type Model, streamSimple } from "@shawnma/pi-ai/compat";
