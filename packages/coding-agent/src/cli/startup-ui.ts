import { ProcessTerminal, setKeybindings, type TUI, TuiMainScreen } from "@shawnma/pi-tui";
...
const OFFICIAL_PACKAGE_NAME = "@shawnma/pi-coding-agent";
const OFFICIAL_APP_NAME = "my-pi";
const OFFICIAL_CONFIG_DIR_NAME = ".my-pi";
