...
Content`,
	...
	describe("auto-discovered skill metadata", () => {
		it(`should use the agent dir as baseDir for user ${CONFIG_DIR_NAME}/agent skills`, async () => {
	...
	describe(".agents/skills auto-discovery", () => {
		...
		it(`should dedupe user skill entries when ~/${CONFIG_DIR_NAME}/agent/skills is a symlink to ~/.agents/skills`, async () => {
			const previousHome = process.env.HOME;
			process.env.HOME = tempDir;
	...
	describe("ignore files", () => {
		...
		it("should not apply parent .gitignore to config-dir auto-discovery", async () => {
