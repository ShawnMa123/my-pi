...
import { Agent, type AgentEvent, type AgentTool } from "@shawnma/pi-agent-core";
import { type AssistantMessage, type AssistantMessageEvent, EventStream, getModel } from "@shawnma/pi-ai/compat";
