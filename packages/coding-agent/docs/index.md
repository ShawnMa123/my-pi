...
```bash
npm uninstall -g @shawnma/pi-coding-agent
```

For pnpm, Yarn, or Bun installs, use the matching global remove command: `pnpm remove -g @shawnma/pi-coding-agent`, `yarn global remove @shawnma/pi-coding-agent`, or `bun uninstall -g @shawnma/pi-coding-agent`.
