...
For TypeScript definitions in your project, inspect `node_modules/@shawnma/pi-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@shawnma/pi-coding-agent";
