...
```typescript
import { createAgentSession, ModelRuntime, SessionManager } from "@shawnma/pi-coding-agent";
...
```bash
npm install @shawnma/pi-coding-agent
```
...
```typescript
import { createAgentSession, SessionManager } from "@shawnma/pi-coding-agent";
...
The `Agent` class (from `@shawnma/pi-agent-core`) handles the core LLM interaction. Access it via `session.agent`.
...
```typescript
import { getModel } from "@shawnma/pi-ai";
import { ModelRuntime } from "@shawnma/pi-coding-agent";
...
```typescript
import { InMemoryCredentialStore } from "@shawnma/pi-ai";
import { createAgentSession, ModelRuntime } from "@shawnma/pi-coding-agent";
...
```typescript
import { createAgentSession, DefaultResourceLoader } from "@shawnma/pi-coding-agent";
...
```typescript
import { createAgentSession } from "@shawnma/pi-coding-agent";
...
import { createAgentSession, defineTool } from "@shawnma/pi-coding-agent";
...
```typescript
import type { InlineExtension } from "@shawnma/pi-coding-agent";
...
```typescript
import { createEventBus, DefaultResourceLoader } from "@shawnma/pi-coding-agent";
...
```typescript
import { createAgentSession, SettingsManager, SessionManager } from "@shawnma/pi-coding-agent";
