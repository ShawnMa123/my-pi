...
const packages = [
	{ directory: "packages/telemetry", name: "@shawnma/pi-telemetry" },
	{ directory: "packages/ai", name: "@shawnma/pi-ai" },
	{ directory: "packages/tui", name: "@shawnma/pi-tui" },
	{ directory: "packages/agent", name: "@shawnma/pi-agent-core" },
	{ directory: "packages/protocol", name: "@shawnma/pi-protocol" },
	{ directory: "packages/client", name: "@shawnma/pi-client" },
	{ directory: "packages/session-backends/sqlite-node", name: "@shawnma/pi-session-backend-sqlite-node" },
	{ directory: "packages/server", name: "@shawnma/pi-server" },
	{ directory: "packages/coding-agent", name: "@shawnma/pi-coding-agent" },
];
